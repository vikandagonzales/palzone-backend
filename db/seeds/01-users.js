    ...
    .then(() => {
      return knex('users').insert(
        [
          ...
          {id:2, first_name: 'Wendy', last_name: 'Parsons', email: 'wendy@email', password:'$2a$10$vj6rshiShRql5E0A5DxKWOW6Qso/8C/U4ycefHIp5I5Ua3GW1HESS', photo: 'http://pupjoyblog.com/wp-content/uploads/2018/05/Body-Language-418x315.jpg', preferred_language: "zh"},
